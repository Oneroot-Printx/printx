...
export default function Footer() {
    ...
    return (
        ...
        <Button className="bt1" color="black" variant="dark" onClick={() => setContactUsModalShow(true)}>
          Contact Us
        </Button>
        ...
        />
        <Button className="bt1" color="black" variant="dark" onClick={() => setPrivacyModalShow(true)}>
        ...
        />
        <Button className="bt1" color="black" variant="dark" onClick={() => setRefundModalShow(true)}>
